...
Ниже — краткие, практичные решения и рекомендации по каждому пункту задания.
...
По запросу могу добавить конкретные команды для изменения конфигурации MySQL, примеры настройки connection pooler или готовые k8s-манифесты под CI/CD.
